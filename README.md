...
## 基本的な考え
都道府県の北緯東経範囲を調べ、東西南北先端緯度経度を定義します。
例えば青森県は北緯40度12分から41度33分、東経139度30分から141度41分の間にあるので、以下のように定義できます。
https://www.pref.aomori.lg.jp/k-kensei/sugata.html#:~:text=青森県は、北緯40,に位置しています%E3%80%82
都道府県SVGの端がこの東西南北端に対応していると仮定すれば、受け取った緯度経度情報をSVG上座標として変換することができます。
